...
const Morefromcategory = ({ post, postId, handleClick }) => {
  const { getAllBlogs } = useContext(BlogContext);
  const [index, setIndex] = useState(3);
  const [isOpen, setIsOpen] = useState(0);

  const posts = getAllBlogs.filter(
    (blog) => blog.id != postId && blog.category === post.category
  );
          ...
          >
            <div class="relative md:flex-shrink-0">
              <img
                ...
                class="object-cover w-full rounded-t-lg md:h-56 h-44"
              />
              <button
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center flex-1">
                  ...
                  <div class="flex flex-col mx-2">
                    <span class="font-semibold hover:underline cursor-default text-left">
                      {blog.author.name}
                    </span>
